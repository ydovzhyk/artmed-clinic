...
//     text: 'Врачи с современным подходом и практическим опытом в различных направлениях медицины.',
//   },
//   {
//     icon: '/images/advantages/technology.png',
//     title: 'Современные технологии',
//     text: 'Используем оборудование и методики, соответствующие актуальным медицинским стандартам.',
//   },
//   {
//     icon: '/images/advantages/individual.png',
//     title: 'Индивидуальный подход',
//     text: 'Каждый пациент получает персональный план лечения и внимательное отношение.',
//   },
//   {
//     icon: '/images/advantages/confidentiality.png',
//     title: 'Комфорт и конфиденциальность',
//     text: 'Мы создаём безопасную и деликатную среду для каждого пациента.',
//   },
// ]
...
//     <section
//       id="advantages"
//       className="scroll-mt-[calc(var(--header-initial-height,_112px)_-_40px)] relative overflow-hidden border-y border-background-border/70 bg-white py-12 md:py-14"
//     >
//       <div className="pointer-events-none absolute inset-0">
//         <div className="absolute -left-24 top-10 h-64 w-64 rounded-full bg-secondary/8 blur-3xl" />
//         <div className="absolute -right-24 bottom-10 h-72 w-72 rounded-full bg-primary/6 blur-3xl" />
//       </div>
...
//           <Text color="muted" className="max-w-2xl">
//             Мы объединяем опыт специалистов, современные технологии и
//             внимательное отношение, чтобы обеспечить высокий уровень медицинской
//             помощи.
//           </Text>
//         </div>

//         {/* ВАЖЛИВО: однакова сітка для laptop + desktop */}
//         <div className="grid gap-4 md:grid-cols-2">
//           {advantages.map((item) => (
//             <div
//               key={item.title}
//               className="rounded-3xl border border-background-border bg-white/80 p-5 shadow-[0_14px_34px_rgba(16,36,50,0.06)] backdrop-blur transition hover:border-secondary/50 hover:shadow-[0_18px_42px_rgba(0,119,168,0.1)]"
//             >
//               <div className="mb-3 flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-secondary-soft ring-1 ring-secondary/20">
//                 <Image
//                   src={item.icon}
//                   alt=""
//                   width={34}
...
//                 as="p"
//                 variant="h3"
//                 className="text-[16px] leading-tight text-brand-blue"
//               >
//                 {item.title}
//               </Text>
